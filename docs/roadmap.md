...
1b. Spanish for the city landed on September 6 (`i18n/town.ts`, inline `tl` pairs) and had a full editorial read on September 7 (build 37: 1,474 pairs, 21 fixes). Still worth an afternoon from a Latin American Spanish speaker; the dashboard's es.json was not part of the read.
