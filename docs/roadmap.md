...
Start with [HANDOVER.md](../HANDOVER.md) §1–6 and [assessment-2026-09-25.md](assessment-2026-09-25.md). **Production is builds 40–59**: `origin/main` = `e3097ca`, four releases on 2026-09-25 with receipts in `docs/verification/release-2026-09-25/`. Build 60 (dialogs fit a phone) is on the branch, not released. 484 tests / 85 files pass.
...
3. ✅ **The real-phone check of builds 52–59** (2026-09-26, `docs/verification/phone-2026-09-26/`): 56–60 fps. It found **build 60**: on a phone, tall dialogs (the Sales quiz, Save and load) hid their close and action buttons. The fix is in `components/Modal.tsx`, on the branch, **awaiting Pieter's release go-ahead**. **A Chromebook check** is still open.
