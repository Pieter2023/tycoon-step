...
Start with [HANDOVER.md](../HANDOVER.md). **All September 5 game work is committed locally (HEAD `8baad7d`); nothing is pushed or deployed.** Latest code validation: 254 tests / 40 files plus a successful production build. The earlier “clean tree”, “deployed” and “no queued build work” statements below apply only to the archived June version.
