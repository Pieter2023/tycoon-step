...
export const COVERAGE: Record<PolicyId, Cover> = {
  health: { name: () => tl('Health cover','Seguro de salud'), blurb: () => tl('Pays 80% of a covered medical bill above your deductible. A lower deductible costs more every month.','Paga el 80% de una factura médica cubierta por encima de tu deducible. Un deducible más bajo cuesta más cada mes.'), events: ['appendicitis', 'sports_injury', 'dental_emergency', 'wisdom_teeth', 'root_canal', 'major_surgery', 'chronic_illness_diagnosis', 'medical_bill_negotiation', 'mental_health_crisis', 'child_sick', 'pet_emergency'], share: .8, deductibles: [500, 2000, 5000], base: [380, 260, 170] },
  property: { name: () => tl('Home & car cover','Seguro de hogar y auto'), blurb: () => tl('Pays 90% of covered repairs, break-ins and accidents above a $1,000 deductible. Each vehicle and each rental property adds to the premium.','Paga el 90% de reparaciones, robos y accidentes cubiertos por encima de un deducible de $1,000. Cada vehículo y cada propiedad en renta suman a la prima.'), events: ['home_repair', 'hvac_failure', 'appliance_breakdown', 'home_break_in', 'car_breakdown', 'car_accident', 'car_totaled', 'phone_stolen', 'rental_major_maintenance'], share: .9, deductibles: [1000], base: [110] },
