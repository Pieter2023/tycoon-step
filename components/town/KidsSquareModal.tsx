    ...
    <div className={`town-body${open ? ' town-details-open' : ''}`}>
      ...
      <aside className="town-details" aria-label={tl('Stop', 'Parada')} style={{ display: open ? 'block' : 'none' }}>
        ...
        {open === 'goal' && <>
          ...
          <p className="town-small">{tl('A goal is a promise to yourself. Every coin you keep is a step closer.', 'Una meta es una promesa que te haces. Cada moneda que guardas es un paso más cerca.')}</p>
